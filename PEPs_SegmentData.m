% Date: 01-03-2021   Programmed by: Deirdre BOLGER
...
%**************************************************************************
Condsoi = {'Patient-Cong','Patient-Incong'};
currsuj = 's31';

dirbase = fullfile(filesep,'Volumes','deepassport','Projects','Project-PEPs','PEPS-protocol-phase2','PEPs_DataPreproc_2021','ToSegment_AudTrigs',filesep);
dirsave = fullfile(filesep,'Volumes','deepassport','Projects','Project-PEPs','PEPS-protocol-phase2','PEPs_DataPreproc_2021','Segmented_AudTrigs',filesep);
dirpath = fullfile(dirbase,currsuj,filesep);
